                ...
                <nav class="main-nav" role="navigation">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            <li class="cl-effect-11"><a href="${pageContext.request.contextPath}/user/homepage/1" data-hover="首页">首页</a></li>
                            <li>
        ...
        <div class="row">
            <main class="col-md-8">
                    ...
                    <article class="post post-1">
                        ...
                        <div class="entry-content clearfix">
                            ...
                            <div class="read-more cl-effect-14">
                                <a href="${pageContext.request.contextPath}/user/getDetailArticle/${article.articleId}" class="more-link">继续阅读 <span class="meta-nav">→</span></a>
                            </div>
                        </div>
                    </article>
                </c:forEach>
                ...
                <div class="pagination">
                    <ul class="pagination">
                        <li><a href="${pageContext.request.contextPath}/user/homepage/1">首页</a></li>
                        ...
                        <c:if test="${pageInfo.isFirstPage==false}">
                            <li class="next"><a href="${pageContext.request.contextPath}/user/homepage/${pageInfo.pageNum-1}"><span aria-hidden="true">&laquo;</span></a></li>
                        </c:if>
                        <c:forEach items="${pageInfo.navigatepageNums}" var="page_Num">
                            <c:if test="${page_Num==pageInfo.pageNum}">
                                <li class="active"><a
                                        href="${pageContext.request.contextPath}/user/homepage/${page_Num}">${page_Num}</a>
                                </li>
                            </c:if>
                            <c:if test="${page_Num!=pageInfo.pageNum}">
                                <li>
                                    <a href="${pageContext.request.contextPath}/user/homepage/${page_Num}">${page_Num}</a>
                                </li>
                            </c:if>
                        </c:forEach>
                        ...
                        <c:if test="${pageInfo.isLastPage==false}">
                            <li class="next"><a href="${pageContext.request.contextPath}/user/homepage/${pageInfo.pageNum+1}"><span aria-hidden="true">&raquo;</span></a></li>
                        </c:if>
                        <li><a href="${pageContext.request.contextPath}/user/homepage/${pageInfo.pages}">末页</a></li>
                    </ul>
                </div>
            </main>
                ...
                <div class="widget widget-tag-cloud">
                    ...
                    <ul>
                        <c:forEach items="${tagList}" var="tag">
                            <li>
                                <a href="${pageContext.request.contextPath}/user/search?tagId=${tag.tagId}&page=1">${tag.tagName}</a>
                            </li>
                        </c:forEach>
                    </ul>
                </div>
