...
<%--            $("#email").text("邮箱不能为空").attr("judge", "fail");--%>
<%--        } else {--%>
<%--            $("#email").text("").attr("judge", "success");--%>
<%--        }--%>
<%--        if (!email.match("^\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*$")) {--%>
<%--            $("#email").text("邮箱格式错误").attr("judge", "fail");--%>
<%--        } else {--%>
<%--            $("#email").text("").attr("judge", "success");--%>
<%--        }--%>
<%--        if (password == "" || password == null) {--%>
<%--            $("#password").text("密码不能为空").attr("judge", "fail");--%>
<%--        } else {--%>
<%--            $("#password").text("").attr("judge", "success");--%>
<%--        }--%>
